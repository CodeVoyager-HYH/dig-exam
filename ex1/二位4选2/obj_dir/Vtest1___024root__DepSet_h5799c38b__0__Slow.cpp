...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vtest1___024root___eval_stl(Vtest1___024root* vlSelf);
...
VL_ATTR_COLD void Vtest1___024root___eval_settle(Vtest1___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vtest1___024root___eval_triggers__stl(vlSelf);
...
#endif
                VL_FATAL_MT("test1.v", 1, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vtest1___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vtest1___024root___dump_triggers__stl(Vtest1___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest1___024root___dump_triggers__stl\n"); );
    // Body
...
void Vtest1___024root___ico_sequent__TOP__0(Vtest1___024root* vlSelf);

VL_ATTR_COLD void Vtest1___024root___eval_stl(Vtest1___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest1___024root___eval_stl\n"); );
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
...
VL_ATTR_COLD void Vtest1___024root___dump_triggers__ico(Vtest1___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest1___024root___dump_triggers__ico\n"); );
    // Body
